<%@ page import="com.efeng.ssm.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.efeng.ssm.domain.Tran" %>
...
<script type="text/javascript">
	...
	function flushTranHistory(){
		$.ajax({
			url : "ssm/transaction/getTranHistoryList",
			data : {
				"tranId": "${tran.id}"
			},
			type : "get",
	...
	function changeStage(stage, i){
		$.ajax({
			url : "ssm/transaction/changeStage",
			data : {
				"stage": stage,
				"id": "${tran.id}",
				"money": "${tran.money}",
