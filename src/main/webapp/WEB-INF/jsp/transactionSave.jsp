	...
	$(function(){
		...
		$("#create-customerName").typeahead({
			source: function (query, process) {
				$.get(
						"ssm/transaction/getCustomerName",
						{ "name" : query },
						function (data) {
							//alert(data);
							process(data);
...
<body>
	...
	<form action="ssm/transaction/saveTran" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;" id="tranForm">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control timea" name="expectedDate" id="create-expectedClosingDate">
			</div>
		</div>
				...
				<select class="form-control" name="type" id="create-transactionType">
				  <option></option>
					<c:forEach items="${transactionTypeList}" var="ttl">
						<option value="${ttl.value}">${ttl.text}</option>
					</c:forEach>
				</select>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="市场营销b">
				<input type="hidden" name="activityId" value="1d94314e951f405ba9a4db66d0b21c3d">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="4aa43ae64bd94cb4bae96bf427cd8ecc"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control timeb" name="nextContactTime" id="create-nextContactTime">
			</div>
		</div>
